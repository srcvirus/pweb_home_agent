...
pweb_home_agent_test:		cassandra_db.o pweb_home_agent_test.o home_agent_index_cassandra_controller.o home_agent_index.o home_agent_server.o io_service_pool.o dns_message_handler.o
				g++ -Wall -g obj/cassandra_db.o obj/pweb_home_agent_test.o obj/home_agent_index_cassandra_controller.o obj/home_agent_index.o obj/home_agent_server.o obj/io_service_pool.o obj/dns_message_handler.o -lpthread -lboost_system -lboost_thread -lssl -lcrypto -lleveldb -lcql -o bin/pweb_home_agent_test
