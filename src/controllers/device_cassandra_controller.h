...
class DeviceCassandraController {
  ...
  void buildDeviceObjectFromQueryResult(cql::cql_result_t &row,
...
public:
  ...
  vector<boost::shared_ptr<Device> > getUserDevices(const string &username,
                                                    string &errorCode);
  boost::shared_ptr<Device> getDevice(const string &devicename,
                                      const string &username,
                                      string &errorCode);
  bool isDevicenameAvailable(const string &devicename, const string &username,
                             string &errorCode);
  int deleteDevice(const string &devicename, const string &username);
  int updateDevice(const string &currentDevicename, const string &newDevicename,
                   const string &username, const string &ip, const string &port,
                   const string &public_folder, const string &private_folder);
  int updateDeviceIPPort(const string &devicename, const string &username,
                         const string &ip, const string &port);
  int updateDeviceMetadata(const string &devicename, const string &username,
                           const string &metadata);
  int updateDevice(const string &currentDevicename, const string &username,
