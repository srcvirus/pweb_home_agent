...
public:
	UserCassandraController():databaseDriver(boost::shared_ptr <CassandraDBDriver>()){;}
	UserCassandraController(boost::shared_ptr <CassandraDBDriver>& databaseDriver):databaseDriver(databaseDriver){;}
