...
template <class KeyType, class ValueType> class LookupTableIterator {
...
public:
  ...
  void reset_iterator() { table_iterator = table_ptr->begin(); }
  ...
  bool hasMoreKey() { return table_iterator != (table_ptr->end()); }
};
