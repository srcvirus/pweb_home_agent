...
public:
  ...
  DNSQueryHeader &getDNSHeader() { return this->header; }

  void setDNSHeader(const DNSQueryHeader &header) { this->header = header; }

  vector<DNSQuestion> &getDNSQuestions() { return this->questions; }

  void setDNSQuestion(const vector<DNSQuestion> &questions) {
